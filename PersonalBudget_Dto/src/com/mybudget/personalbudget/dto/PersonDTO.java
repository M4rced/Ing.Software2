...
public final class PersonDTO {
	...
	public PersonDTO(final String id,final String idCard,final String firstName,final String middleName,final String firstSurname,
	...
	public static final PersonDTO build() {
